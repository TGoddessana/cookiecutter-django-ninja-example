...
# cookiecutter_django_ninja_example/
APPS_DIR = BASE_DIR / "cookiecutter_django_ninja_example"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///cookiecutter_django_ninja_example",
    ),
}
...
LOCAL_APPS = [
    "cookiecutter_django_ninja_example.users",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "cookiecutter_django_ninja_example.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""TGoddessana""", "twicegoddessana1229@gmail.com")]
